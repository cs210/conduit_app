...
class SettingsViewController : UITableViewController, ConfirmPasswordDelegate, SWRevealViewControllerDelegate {
  var menuOptions = ["Change Name", "Change Password", "Change Email", "Change Phone Number", "Car Management"]
  var segueOptions = ["change_name_segue", "change_password_segue", "change_email_segue", "change_phone_segue", "car_management_segue"]
